...
author: "Sergio Pedro Rodrigues Oliveira e Raphael"
date: "19 de Junho de 2025" # Data atual, pode ser ajustada
format:
  html:
    toc: true # Tabela de Conteúdo
    toc-depth: 3 # Nível da Tabela de Conteúdo
    code-fold: false
...
* **Escalabilidade Futura:** Possibilidade de adicionar:
    * Cálculo para outros tipos de linhas de transmissão (por exemplo, cabos subterrâneos, linhas de transmissão com múltiplas fases complexas).
